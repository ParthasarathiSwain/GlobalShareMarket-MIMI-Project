					...
					<div class="col-xl-5 col-md-6">
						...
						<div class="auth-form card">
							...
							<h4>Broker Registration</h4>
								<form id="brokerRedg" class="signin_validate row g-2">
									<div class="col-12">
										<input type="text" class="form-control" placeholder="Enter Name" name="userName">
									</div>
									<div class="col-12">
										<input type="email" class="form-control"  placeholder="broker@example.com" name="userEmail"> 
										<input type="hidden" name="event" value="brokerRedg">
									</div>
									<div class="col-12">
								...
								<div class="text-center">
                                <p class="mt-3 mb-0"> <a class="text-primary" href="login.jsp">Sign in</a> to your
                                    account</p>
                            </div>
							</div>
	 ...
	 <!-- toast -->
        ...
        <script>
		  	$(document).ready(function(){
		  		...
		  		$("#brokerRedg").on('submit',function(event){
		  			event.preventDefault();
					var f=new FormData($(this)[0]);
					$.ajax({
		  				url:"brokerController",
		  				data:f,
		  				type:'POST',
		  				async: false,
