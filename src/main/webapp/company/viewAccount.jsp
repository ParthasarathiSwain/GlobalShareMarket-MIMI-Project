	    				...
	    				for (var key in data) {
	    					if (data.hasOwnProperty(key)) {
	    					  ...
	    					  if(status==1){
		    					  ...
		    					  s+="<td><div class='d-flex order-actions'><a class=' bg-primary acc_edit'  id='"+data[key].accId+"'><i class='bx bxs-edit'></i></a>&nbsp";
		    					  s+="<a class='acc_delete bg-danger'  id='"+data[key].accId+"'><i class='bx bxs-trash'></i></a><div></td>";
	    					  }else{
	    						  s+="<tr >";
		    					  s+="<td>"+i+"</td>";
		    					  s+="<td>"+data[key].accName+"</td>";
