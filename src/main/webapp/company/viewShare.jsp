...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="updateShare" >
								<h5 class="mb-4">Edit Share </h5>
								<div class="row mb-3">
									<label for="userName" class="col-sm-3 col-form-label">Share Name</label>
									<div class="col-sm-9">
										<input type="hidden" name="event" value="updateShare">
