...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form id="custUpdate" >
								<h5 class="mb-4">Edit Broker </h5>
								<div class="row mb-3">
									<label for="userName" class="col-sm-3 col-form-label">Enter Name</label>
									<div class="col-sm-9">
		  		...
		  		$("#custUpdate").on('submit',function(event){
					...
					$.ajax({
		  				...
		  				success:function(data,textStatus,jqXHR){
			  				if(data.trim() ==='done'){			  					
			  					window.location.href = 'viewBroker.jsp';		  				
			  		  		}else{
					  		  		$.toast({
	    				...
	    				for (var key in data) {
	    					if (data.hasOwnProperty(key)) {
	    					  ...
	    					  if(status==1){
		    					  ...
		    					  s+="<td><img src='../images/brokerImg/"+data[key].userImg+"' class='product-img-2' ></td>";
