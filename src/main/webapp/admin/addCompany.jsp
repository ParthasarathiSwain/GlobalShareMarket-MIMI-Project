				...
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="card">
							...
							<form id="companyRedg" >
								<h5 class="mb-4">Add Company Form</h5>
								<div class="row mb-3">
									<label for="userName" class="col-sm-3 col-form-label">Company Name</label>
									<div class="col-sm-9">
								...
								<div class="row mb-3">
										<label for="userImg" class="col-sm-3 col-form-label">Company Photo</label>
										<div class="col-sm-9">
