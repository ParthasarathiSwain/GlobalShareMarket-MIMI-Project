				...
				<div class="row">
					<div class="col-lg-8 mx-auto">
						<div class="card">
							...
							<form id="brokerRedg" >
								<h5 class="mb-4">Add Broker Form</h5>
								<div class="row mb-3">
									<label for="userName" class="col-sm-3 col-form-label">Enter Broker Name</label>
									<div class="col-sm-9">
								...
								<div class="row mb-3">
										<label for="userImg" class="col-sm-3 col-form-label">Broker Photo</label>
										<div class="col-sm-9">
