				...
				<nav class="navbar navbar-expand gap-3">
								...
								<div class="dropdown-menu dropdown-menu-end">
									...
									<div class="header-notifications-list">
										...
										<a class="dropdown-item" href="javascript:;">
											<div class="d-flex align-items-center">
												<div class="user-online">
													<img src="../images/adminImg/<% out.print(request.getSession().getAttribute("img")); %>" class="msg-avatar" alt="user avatar">
												</div>
												<div class="flex-grow-1">
					...
					<div class="user-box dropdown px-3">
						<a class="d-flex align-items-center nav-link dropdown-toggle gap-3 dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="../images/adminImg/<% out.print(request.getSession().getAttribute("image")); %>" class="user-img" alt="user avatar">
							<div class="user-info">
								<p class="user-name mb-0"><% out.print(request.getSession().getAttribute("name")); %></p>
						...
						<ul class="dropdown-menu dropdown-menu-end">
							...
							<li><a class="dropdown-item d-flex align-items-center" href="logout.jsp"><i class="bx bx-log-out-circle"></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
